...
yes|sudo dnf install vim man htop ncdu tar zip git autojump expect wget aria2 nload gcc octave
...
######### Desktop Stuff ###############
#yes|sudo dnf install i3 mpv emacs emacsclient rxvt-unicode-256color acpi mirage shotwell evince feh powertop
#git clone http://github.com/syl20bnr/spacemacs ~/.emacs.d

#yes|sudo dnf install python3-qt5 python3-sip
